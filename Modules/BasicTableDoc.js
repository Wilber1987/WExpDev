...
class BasicTable {
    constructor() {
        ...
        this.children.push(new WTableComponent(Config))
    }
}
    ...
    constructor() {
        ...
        this.children.push({
            ...
            props: {
                style: "padding: 10px",
                innerHTML: `
                <div contenteditable="true"><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;">En caso de no querer tener a disposición las opciones de paginación es posible deshabilitarla usando el atributo paginate:false dentro de TableConfig</p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><br><div>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #4fc1ff;">Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{&nbsp;<span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,&nbsp;<span style="color: #9cdcfe;">paginate</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">false</span>};</div><br></div><p class="MsoNormal"><o:p></o:p></p><p class="MsoNormal"><o:p></o:p></p></div>
                `
            }
        });
        this.children.push(new WTableComponent({
            Dataset: Data,
            paginate: false,
            Options: {
                Search: true,
    ...
    constructor() {
        ...
        this.children.push({
            ...
            props: {
                style: "padding: 10px",
                innerHTML: `
                <div contenteditable="true"><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;"><font face="Calibri, sans-serif"><span style="font-size: 11pt;">Es posible implementar opciones de&nbsp;</span><span style="font-size: 14.6667px;">búsqueda</span><span style="font-size: 11pt;">.&nbsp;</span></font></p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><br><div>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #4fc1ff;">Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Options</span><span style="color: #9cdcfe;">:</span>&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Search</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">true</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><br><br></div><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;">En caso que se desee implementar opciones de búsqueda por medio de una api, se debe utilizar la propiedad UrlSearch:"api_route" junto a la propiedad Search dentro del TableConfig -&gt;Options, esto permitirá que al momento de hacer el filtrado, de no encontrarse el resultado dentro del arreglo de datos originales, realice una petición a la api en busca de las coincidencias.<br></p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><br><div><span style="color: #4fc1ff;">  Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #9cdcfe;">Options</span><span style="color: #9cdcfe;">:</span>&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Search</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">true</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">UrlUpdate</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #ce9178;">"https://route....."</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp; }</div><div>  };</div><br></div><p class="MsoNormal"><o:p></o:p></p><p class="MsoNormal"><o:p></o:p></p></div>
                `
            }
        });
        this.children.push(new WTableComponent({
    ...
    constructor() {
        ...
        this.children.push({
            ...
            props: {
                style: "padding: 10px",
                innerHTML: `
                    <div contenteditable="true"><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;">Para habilitar las opciones de edición de registro usar la propiedad Edit=true dentro de TableConfig-&gt;Options.&nbsp;</p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><span style="color: #4fc1ff;"><br></span></div><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><span style="color: #4fc1ff;">    Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{&nbsp;<span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,&nbsp;<span style="color: #9cdcfe;">Options</span><span style="color: #9cdcfe;">:</span>&nbsp;{&nbsp;<span style="color: #9cdcfe;">Edit</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">true</span>,&nbsp;}&nbsp;};</div><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><br></div><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;">Para habilitar la actualización por medio de una Api usar la propiedad UrlUpdate junto a la propiedad Edit=true</p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><br><div><span style="color: #4fc1ff;">Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,&nbsp;<span style="color: #9cdcfe;">Options</span><span style="color: #9cdcfe;">:</span>&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Edit</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">true</span>,&nbsp;<span style="color: #9cdcfe;">UrlUpdate</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #ce9178;">"https//url....."</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>};</div><br></div><p class="MsoNormal"><o:p></o:p></p><p class="MsoNormal"><o:p></o:p></p></div>
                `
            }
        });
        this.children.push(new WTableComponent({
    ...
    constructor() {
        ...
        this.children.push({
            ...
            props: {
                style: "padding: 10px",
                innerHTML: `
                    <div contenteditable="true"><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;">Para habilitar las opciones de eliminación de registro usar la propiedad Delete=true dentro de TableConfig-&gt;Options.&nbsp;</p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><span style="color: #4fc1ff;"><br></span></div><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><span style="color: #4fc1ff;">    Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{&nbsp;<span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,&nbsp;<span style="color: #9cdcfe;">Options</span><span style="color: #9cdcfe;">:</span>&nbsp;{&nbsp;<span style="color: #9cdcfe;">Delete</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">true</span>,&nbsp;}&nbsp;};</div><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><br></div><p class="MsoNormal" style="font-family: Arial, Helvetica, sans-serif;">Para habilitar la eliminar por medio de una Api usar la propiedad UrlDelete junto a la propiedad Delete=true</p><div style="color: rgb(212, 212, 212); background-color: rgb(30, 30, 30); font-family: Consolas, &quot;Courier New&quot;, monospace; font-size: 14px; line-height: 19px; white-space: pre;"><div><div style="line-height: 19px;"><br><div>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #4fc1ff;">Wtable</span>.<span style="color: #9cdcfe;">TableConfig</span>&nbsp;=&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Dataset</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #4fc1ff;">Data</span>,&nbsp;<span style="color: #9cdcfe;">Options</span><span style="color: #9cdcfe;">:</span>&nbsp;{</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #9cdcfe;">Delete</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #569cd6;">true</span>,&nbsp;<span style="color: #9cdcfe;">UrlDelete</span><span style="color: #9cdcfe;">:</span>&nbsp;<span style="color: #ce9178;">"https//url....."</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;&nbsp;&nbsp;};</div></div></div><br></div><p class="MsoNormal"><o:p></o:p></p><p class="MsoNormal"><o:p></o:p></p></div>
                `
            }
        });
        this.children.push(new WTableComponent( {
