...
let onload = function() {
    ...
    var canvas = document.getElementById('5module1Module1');
    var ctx = canvas.getContext('2d');
    var w = document.getElementById('5module1Module1').offsetWidth;
    var h = document.getElementById('5module1Module1').offsetHeight;
